        ...
        <div class="container py-4 py-lg-5">
            <div class="row justify-content-center">
                ...
                <div class="col-lg-3 text-center text-lg-start d-flex flex-column align-items-center order-first align-items-lg-start order-lg-last">
                    ...
                    <p style="color: var(--bs-white);"><div id="mysitemapgenerator_loadcorsdata" data-token="75e3a3362c516bae1bf8712e1d68f0b2" data-domain="www.mysitemapgenerator.com"></div><script src="https://cdn.mysitemapgenerator.com/api/embedmap.m.js"></script></p>
                </div>
            </div>
            <hr>
