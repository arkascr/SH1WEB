        ...
        <section class="clean-block about-us">
            <div class="container">
                <div class="block-heading">
                    <h2 class="text-info">¿necesitas ayuda?</h2>
                    <p>selecciona cualquiera de nuestras opciones</p>
                </div>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="card text-center clean-card"><!--img class="card-img-top w-100 d-block card-img-top w-100" src="assets/img/avatars/avatar1.jpg"-->
                            <div class="card-body info">
                                ...
                                <p class="card-text" style="text-align: justify;">Presiona el siguiente enlace para <a href="registrar.php" style="font-family: Arial, Helvetica, sans-serif;">crear cuenta</a></p>
                                <!--div class="icons"><a href="#"><i class="icon-social-facebook"></i></a><a href="#"><i class="icon-social-instagram"></i></a><a href="#"><i class="icon-social-twitter"></i></a></div-->
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-lg-4">
                        <div class="card text-center clean-card"><!--img class="card-img-top w-100 d-block card-img-top w-100" src="assets/img/avatars/avatar1.jpg"-->
                            <div class="card-body info">
                                ...
                                <p class="card-text" style="text-align: justify;">Para dirigirte al formulario de contacto haz click en el siguiente enlace <a href="contacto.php" style="font-family: Arial, Helvetica, sans-serif;">contactanos</a></p>
                                <!--div class="icons"><a href="#"><i class="icon-social-facebook"></i></a><a href="#"><i class="icon-social-instagram"></i></a><a href="#"><i class="icon-social-twitter"></i></a></div-->
                            </div>
                        </div>
                    </div>
