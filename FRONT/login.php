...
<body>
    <nav class="navbar navbar-expand-md sticky-top navbar-shrink py-3 navbar-light" id="mainNav" style="background: var(--bs-primary-bg-subtle);">
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="/"><span class="bs-icon-sm bs-icon-circle bs-icon-primary shadow d-flex justify-content-center align-items-center me-2 bs-icon"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-shop-window">
                    ...
                    </svg></span><span>Books Zone</span></a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-2"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navcol-2" style="transform: translate(50px) scale(0.70);"><input class="border rounded border-1 shadow-sm focus-ring focus-ring-primary form-control-sm" type="search" placeholder="Buscar libros" required="" style="transform: perspective(0px) translate(-100px) scale(1.50);width: 350px;">
                <ul class="navbar-nav mx-auto">
                    ...
                    </svg>&nbsp;Registrar</a><a class="btn btn-primary shadow" role="button" href="signup.php" style="width: 226.034px;"><svg xmlns="http://www.w3.org/2000/svg" viewBox="-32 0 512 512" width="1em" height="1em" fill="currentColor" style="font-size: 28px;">
                    ...
                    </svg>&nbsp;Iniciar Sesión</a><a class="btn btn-primary shadow" role="button" href="signup.php" style="width: 176.653px;"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-cart4" style="font-size: 28px;">
    ...
    <main class="page login-page">
        <section class="clean-block clean-form dark">
            <div class="container">
                ...
                <form>
                    <div class="mb-3"><label class="form-label form-label" for="email">Email</label><input class="form-control form-control item" type="email" data-bs-theme="light" id="email"></div>
                    <div class="mb-3"><label class="form-label form-label" for="password">Password</label><input class="form-control form-control" type="password" data-bs-theme="light" id="password"></div>
                    <div class="mb-3">
                        <div class="form-check"><input type="checkbox" class="form-check-input" data-bs-theme="light" id="checkbox"><label class="form-label form-check-label" for="checkbox">Remember me</label></div>
