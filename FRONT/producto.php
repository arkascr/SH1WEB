...
<head>
    ...
    <title>Product - Books Zone</title>
...
<body>
    ...
    <section class="py-5">
        <div class="container py-5">
            <div data-reflow-type="product" data-bss-dynamic-product="" data-bss-dynamic-product-param="product" data-reflow-shoppingcart-url="carrito.html"></div>
        </div>
    </section>
